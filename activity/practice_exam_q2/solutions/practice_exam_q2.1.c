...
//
// So, if I compile this 'practice_exam_q2' function on the AMD64 processor
...
// extension, SSE4::
//
//   :jaenelle: clang -msse4 -O1 -c practice_exam_q2.1.c
//   :jaenelle: objdump -d practice_exam_q2.1.o | sed -ne '/<practice_exam_q2>:/,$ {p}'
//   0000000000000060 <practice_exam_q2>:
